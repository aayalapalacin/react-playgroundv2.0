    ...
    <div className="container justify-items-center  ">
        <div className="welcome-container flex justify-center items-center w-8/12">
            ...
            <div className="welcome-text-container">
              ...
              <p> We are two self-taught developers on a mission to break down the trickier parts of React—secure
                 logins, chatbots, file uploads, and more. As we learn, we share step-by-step tutorials that are clear, practical, and beginner-friendly.
                  Whether you are leveling up or just curious, join us as we tackle the stuff that used to give us anxiety—so it doesn’t have to give you any. 🚀
              </p>
            </div>
        </div>
